...
import 'package:tradix/app/dependency_injection/third_party.dart' as _i12;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i9.SystemMessageCubit>(() => _i9.SystemMessageCubit());
    gh.factory<_i10.UserMessageCubit>(() => _i10.UserMessageCubit());
    gh.factory<_i11.AIMessageBloc>(
        () => _i11.AIMessageBloc(gh<_i5.ChatOpenAIRepository>()));
    return this;
  }
}
